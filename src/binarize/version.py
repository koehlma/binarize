...
__version__ = '0.0.1'
__project__ = 'Binarize'
__short_name__ = 'binarize'
__author__ = 'Maximilian Köhl'
__email__ = 'linuxmaxi@googlemail.com'
__website__ = 'http://www.github.com/socialcube/binarize'
__download_url__ = 'https://github.com/socialcube/binarize/tarball/master'
